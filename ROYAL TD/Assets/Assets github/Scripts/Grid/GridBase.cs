        ...
        if (showDebug)
        {
            ...
            for (int x = 0; x < gridArray.GetLength(0); x++)
            {
                for (int y = 0; y < gridArray.GetLength(1); y++)
                {
                    ...
                    Debug.DrawLine(GetWorldPosition(x, y), GetWorldPosition(x, y + 1), new Color(170f / 255f, 170f / 255f, 170f / 255f, 0.4f), 100f);
                    Debug.DrawLine(GetWorldPosition(x, y), GetWorldPosition(x + 1, y), new Color(170f / 255f, 170f / 255f, 170f / 255f, 0.4f), 100f);
                }
            }
            Debug.DrawLine(GetWorldPosition(0, height), GetWorldPosition(width, height), new Color(170f / 255f, 170f / 255f, 170f / 255f, 0.4f), 100f);
            Debug.DrawLine(GetWorldPosition(width, 0), GetWorldPosition(width, height), new Color(170f / 255f, 170f / 255f, 170f / 255f, 0.4f), 100f);
